...
* `u16-packetsize` : By default the packet header sizes are expected to be u32.
                     Using this feature cuts back that to u16 if your needs
                     are more specific and you plan to run small packets.

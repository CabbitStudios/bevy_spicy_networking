...
use bevy_networking_simple::{NetworkMessage, ServerMessage, ClientMessage};
...
pub fn client_register_network_messages(app: &mut AppBuilder) {
    use bevy_networking_simple::AppNetworkClientMessage;
...
pub fn server_register_network_messages(app: &mut AppBuilder) {
    use bevy_networking_simple::AppNetworkServerMessage;
